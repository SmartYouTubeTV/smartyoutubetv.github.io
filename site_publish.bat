...
for %%s in ("git@github.com:SmartTubeApp/SmartTubeApp.github.io.git" "git@github.com:SmartTubeOfficial/SmartTubeOfficial.github.io.git" "git@github.com:SmartYouTubeTV/SmartYouTubeTV.github.io.git" "git@github.com:SmartTubeNext/SmartTubeNext.github.io.git") do call :publishSite %%s
