...
for %%s in ("git@github.com:SmartTubeNext/SmartTube.github.io.git" "git@github.com:SmartYouTubeTV/SmartYouTubeTV.github.io.git" "git@github.com:SmartTubeNext/SmartTubeNext.github.io.git") do call :publishSite %%s
